...
with sync_playwright() as p:
    ...
    page.screenshot(path='c:/Users/NK/Desktop/MOD/3105-repo/admin/fix28d_dash.png')

    # Open dashboard settings menu, click pink shadow
    page.click('#settingsBtn')
    page.wait_for_timeout(500)
    ...
    ''')
    print(f'  After clicking pink shadow btn on dashboard: {s2}')
    page.screenshot(path='c:/Users/NK/Desktop/MOD/3105-repo/admin/fix28d_pink_clicked.png')
    ...
    page.screenshot(path='c:/Users/NK/Desktop/MOD/3105-repo/admin/fix28d_reload.png')
