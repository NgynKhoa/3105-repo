...
with sync_playwright() as p:
    ...
    print('\n=== Open Dashboard, click pink shadow btn ===')
    ...
    ''')
    print(f'  BEFORE click shadow btn: {s}')

    # Open settings panel and click shadow tab
    page.click('#settingsBtn')
    page.wait_for_timeout(300)
    page.click('#tabShadow')
    page.wait_for_timeout(300)
    ...
    ''')
    print(f'  AFTER click pink shadow btn: {s}')
    page.screenshot(path='c:/Users/NK/Desktop/MOD/3105-repo/admin/fix28_dash_pink_shadow.png')

    print('\n=== Reload Dashboard, check if logo still orange ===')
